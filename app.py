...
# -----------------------------
# USE YOUR intent_data HERE
# -----------------------------
# (PASTE YOUR intent_data LIST HERE EXACTLY AS YOU HAVE IT)
...
# -----------------------------
intent_counts = torch.sum(Y_train, dim=0)
total_samples = Y_train.shape[0]
pos_weights = total_samples / (intent_counts + 1e-5)
