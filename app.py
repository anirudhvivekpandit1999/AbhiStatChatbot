...
class TransformerLLM:
    ...
    {"text": "call the new sheet PI Data", "intent": "set_pre_sheet_name"},
{"text": "name the sheet PI Data", "intent": "set_pre_sheet_name"},
{"text": "set sheet name to PI Data", "intent": "set_pre_sheet_name"},
{"text": "rename it to PI Data", "intent": "set_pre_sheet_name"},
{"text": "change the sheet name to PI Data", "intent": "set_pre_sheet_name"},
{"text": "use PI Data as sheet name", "intent": "set_pre_sheet_name"},
{"text": "make the sheet name PI Data", "intent": "set_pre_sheet_name"},
{"text": "sheet name is PI Data", "intent": "set_pre_sheet_name"},
{"text": "call it PI Data", "intent": "set_pre_sheet_name"},
{"text": "name it PI Data", "intent": "set_pre_sheet_name"},
{"text": "rename sheet to PI Data", "intent": "set_pre_sheet_name"},
{"text": "set shet name to PI Data", "intent": "set_pre_sheet_name"},
{"text": "sheet nme PI Data", "intent": "set_pre_sheet_name"},
