...
def main():
    ...
    intent_training_data = [
        ...
        {"text": "change the name of the sheet", "intent": "name_new_sheet"},
        {"text": "i want to name this base sheet as", "intent": "name_new_sheet"},
        ...
        {"text": "make a new formula column", "intent": "add_formula_column"},
        {"text": "i want to add a formula column", "intent": "add_formula_column"},
        {"text": "open formula builder", "intent": "add_formula_column"},
        {"text": "open column builder", "intent": "add_formula_column"},
        {"text": "start formula builder", "intent": "add_formula_column"},
        {"text": "start column builder", "intent": "add_formula_column"},
        {"text": "create formula column", "intent": "add_formula_column"},
        {"text": "i want to add a column with a formula", "intent": "add_formula_column"},
        {"text": "i want to create a column with a formula", "intent": "add_formula_column"},
        ...
        {"text": "i am done with this final sheet", "intent": "submit_sheet"},
        {"text": "this is the final sheet", "intent": "submit_sheet"},
        {"text": "this is the last step", "intent": "submit_sheet"},
        {"text": "go to the last step", "intent": "submit_sheet"},
        {"text": "finalize this sheet", "intent": "submit_sheet"},
